...
def tridiagonal_lu(A):
    ...
    U[1][1] = b[1]
    for k in range(1, n):
      L[k][k-1] = a[k-1]/U[k-1][k-1] # a[k-1] is actually a_k since it starts at a_2
...
A = [[1, 2, 0, 0], [2, 2, 2, 0], [0, 1, 1, 4], [0, 0, 7, 4]]
# diagonals(A) = [[2, 1, 7], [1, 2, 1, 3], [2, 2, 4]]
b = [3, 6, 6, 11]
for part in tridiagonal_decompose_and_solve(A, b):
    pprint(part, width=30)
    print
